...
### 🎀 *I love to learn, explore, and create new things*
...
Hi! I'm **Hriddhima Sharma** — someone who thrives on curiosity and growth. I love learning new things, whether it's picking up a new language, diving into a creative project, or exploring the ever-evolving world of **AI and Machine Learning**.

I have a passion for **coding** and enjoy the way it blends logic with creativity to build something meaningful from scratch. **Public speaking** is another avenue where I love to express ideas and connect with people, turning thoughts into conversations that inspire.

When it comes to the future, I'm particularly drawn to opportunities in **AI & ML**, but I keep an open mind — because the best paths are often the ones you least expect. At my core, I'm a **creator** and a **learner**, always excited about what comes next. ✨
...
![Python](https://img.shields.io/badge/Python-FFB3D1?style=for-the-badge&logo=python&logoColor=FF5C96)
![TensorFlow](https://img.shields.io/badge/TensorFlow-FFD6E7?style=for-the-badge&logo=tensorflow&logoColor=FF5C96)
![HTML5](https://img.shields.io/badge/HTML5-FFB3D1?style=for-the-badge&logo=html5&logoColor=FF5C96)
